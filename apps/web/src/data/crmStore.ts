    ...
    },
    {
      ...
      activities: [
        ...
        },
        {
          ...
          body: 'Marina, enviei o link da demo da Retaguarda. Me avisa se abriu?',
          fromSellerId: bruno?.id ?? null,
          fromName: bruno?.name ?? 'Vendedor',
      ...
      messages: [
        {
          ...
          fromSellerId: bruno?.id ?? null,
          fromName: bruno?.name ?? 'Vendedor',
          text: 'Marina, enviei o link da demo da Retaguarda. Me avisa se abriu?',
          createdAt: hoursAgo(18),
        },
      ],
    },
